...
func main() {
	...
	r.HandleFunc("/v1/profile/deleted-work-experience/{work_experience_id}", handlerProfile.DeletedWorkExperience).Methods(http.MethodDelete)
	...
	r.HandleFunc("/v1/profile/deleted-education/{education_id}", handlerProfile.DeletedEducation).Methods(http.MethodDelete)
	...
	r.HandleFunc("/v1/admin/delete-job/{job_id}", handlerJobs.DeleteJob).Methods(http.MethodDelete)
